...
npx @vscode/vsce ls                        # assert payload: package.json, README.md, LICENSE, images/icon.png, dist/extension.js, assets/inline/warning-icon.svg, assets/gutter/override-winner-{light,dark}.svg (runtime-resolved decoration icons must ship; only assets/gutter/yellow-triangle.svg stays excluded as legacy)
